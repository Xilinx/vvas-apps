...
startgroup
set_property -dict [list CONFIG.STRATEGY {0} CONFIG.S00_HAS_DATA_FIFO {0}] [get_bd_cells axi_ic_ps_e_S_AXI_HPC1_FPD]
endgroup
startgroup
set_property -dict [list CONFIG.STRATEGY {0} CONFIG.S00_HAS_DATA_FIFO {0}] [get_bd_cells axi_ic_ps_e_S_AXI_HP2_FPD]
endgroup
startgroup
set_property -dict [list CONFIG.STRATEGY {0} CONFIG.S00_HAS_DATA_FIFO {0}] [get_bd_cells axi_ic_ps_e_S_AXI_HPC0_FPD]
endgroup
